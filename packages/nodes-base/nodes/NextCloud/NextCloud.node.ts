				...
				options: [
					{
						...
						type: 'multiOptions',
						options: [
							{ name: 'Comments Unread', value: 'oc:comments-unread' },
							{ name: 'Contained File Count', value: 'nc:contained-file-count' },
							{ name: 'Contained Folder Count', value: 'nc:contained-folder-count' },
							{ name: 'Content Type', value: 'd:getcontenttype' },
							{ name: 'eTag', value: 'd:getetag' },
							{ name: 'Favorite', value: 'oc:favorite' },
							{ name: 'File ID', value: 'oc:fileid' },
							{ name: 'Content Length', value: 'd:getcontentlength' }, // Renamed from File Path
							{ name: 'Has Preview', value: 'nc:has-preview' },
							{ name: 'Last Modified', value: 'd:getlastmodified' },
							{ name: 'Owner Display Name', value: 'oc:owner-display-name' },
							{ name: 'Permissions', value: 'oc:permissions' },
							{ name: 'Resource Type', value: 'd:resourcetype' },
							{ name: 'Share Types', value: 'oc:share-types' },
							{ name: 'Size', value: 'oc:size' },
							{ name: 'Creation Date', value: 'd:creationdate' },
							{ name: 'Content Language', value: 'd:getcontentlanguage' },
							{ name: 'Display Name', value: 'd:displayname' },
							{ name: 'Lock Discovery', value: 'd:lockdiscovery' },
							{ name: 'Quota Available Bytes', value: 'd:quota-available-bytes' },
							{ name: 'Quota Used Bytes', value: 'd:quota-used-bytes' },
							{ name: 'Supported Lock', value: 'd:supportedlock' },
							{ name: 'Instance-wide File ID', value: 'oc:id' },
							{ name: 'Download URL', value: 'oc:downloadURL' },
							{ name: 'Creation Time (timestamp)', value: 'nc:creation_time' },
							{ name: 'Mount Type', value: 'nc:mount-type' },
							{ name: 'Hide Download', value: 'nc:hide-download' },
							{ name: 'Is Encrypted', value: 'nc:is-encrypted' },
							{ name: 'Is Mount Root', value: 'nc:is-mount-root' },
							{ name: 'Tags', value: 'oc:tags' },
							{ name: 'Comments Href', value: 'oc:comments-href' },
							{ name: 'Comments Count', value: 'oc:comments-count' },
							{ name: 'Owner ID', value: 'oc:owner-id' },
						],
						default: [],
			...
			try {
				if (resource === 'file') {
					...
					if (operation === 'create') {
						...
						const folderListOptions = this.getNodeParameter('folderListOptions', i, {}) as IDataObject;
